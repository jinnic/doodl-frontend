      ...
      <div className="col-lg-4 col-md-6 col-sm-6 col-12 grid-gap">
        ...
        <div className="like-title-container">
            ...
            <div className="like">
              ...
              <svg width="1em" height="1em" viewBox="0 0 16 16" onClick={this.props.user.id ? this.handleLike : null} className={this.state.likeStatus ? "like align-middle bi bi-heart-fill" : "liked align-middle bi bi-heart-fill"} xmlns="http://www.w3.org/2000/svg">
